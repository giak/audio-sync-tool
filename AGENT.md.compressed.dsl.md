...
> v1.3 — Format libre (graphe de dépendances) : le document source utilise déjà les symboles ◉/◆/⟐/△ en inline,
> ce format évite la collision sémantique.
...
| Section originale | Section DSL | Couverture |
|---|---|---|
| DSL (symboles) | Glossaire (format libre) | complète — remappé en %/$/!/#/&/~ |
| IDENTITY | @AudioSyncTool | complète |
| DATA-SAFETY | %DATA-SAFETY | complète — 5 règles + allowed/needs-confirm |
| RIGUEUR | %RIGUEUR | complète |
| HONESTY | %HONESTY | complète — 3 sous-sections |
| STACK | %STACK | complète |
| STRUCTURE | %STRUCTURE | complète — arbre 16 entrées |
| ARCHITECTURE | %ARCHITECTURE (routes + frontend + keyboard) | complète |
| COMMANDS | (inline dans %STACK + %WORK-RULES) | complète |
| SURGERY | %SURGERY (S1-S12) | complète — 12 règles |
| WORK-RULES | %WORK-RULES (W1-W8) | complète — 8 règles |
| AGENT-FLUX | %AGENT-FLUX | complète |
