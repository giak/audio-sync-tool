...
- **EPIC-035 P1+P2 livrés** (2026-09-19, 11 commits P1 `c6fcfdf` → `cd12601`, P2 `09705b3`)
  ...
  **P2** : genre ID3 lu au scan (TCON/GENRE/©gen), `_build_source_index` (artiste→styles
  ...
  réel. Suite : P3 `TCON` via export → `apply_styles.py`.
- Prochains chantiers : **EPIC-035 P3** (écriture TCON via export → script),
  **EPIC-033-bis** (re-scan du corpus puis collectes incrémentales sur les ~3 551 nouveaux fichiers sans année), **EPIC-031 P2**
