// ─── Tests for initConfigUI / renderConfigSelect from actions.js ────────
// Separated from actions.test.js because config DOM elements must exist
// BEFORE the module is imported (actions.js binds cfgSelect at module scope).
...
beforeEach(() => {
  ...
  document.getElementById('cfg-source').value = '';
  document.getElementById('cfg-epars').value = '';
...
describe('initConfigUI', () => {
  ...
  it('saves config when btn-save-config is clicked', async () => {
    ...
    document.getElementById('cfg-name').value = 'my config';
    document.getElementById('cfg-source').value = '/home/music';
    document.getElementById('cfg-epars').value = '/usb\n/sdcard';
